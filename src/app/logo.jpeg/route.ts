...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600">
  ...
  <g transform="translate(100, 160)">
    <rect x="0" y="0" width="120" height="120" rx="26" fill="#10b981"/>
    <path d="M60 26c16 16 32 20 45 22v26c0 40-22 66-45 82-23-16-45-42-45-82V48c13-2 29-6 45-22z" fill="#06281f" opacity="0.25"/>
    <path d="M60 34c14 14 28 17 39 19v21c0 33-18 55-39 69-21-14-39-36-39-69V53c11-2 25-5 39-19z" fill="#ffffff" opacity="0.95"/>
  </g>
  <g fill="#ffffff" font-family="ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" transform="translate(250, 250)">
    <text x="0" y="0" font-size="26" font-weight="700">Brigada Ambiental International</text>
    <text x="0" y="38" font-size="16" opacity="0.9">Logo (JPEG) não encontrado no servidor.</text>
  </g>
</svg>`;
